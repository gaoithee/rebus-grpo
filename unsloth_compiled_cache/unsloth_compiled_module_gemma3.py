...
from transformers.models.gemma3.modeling_gemma3 import (Optional, Tuple, torch, nn, ACT2FN, ROPE_INIT_FUNCTIONS, dynamic_rope_update, Gemma3Config, Gemma3TextConfig)
