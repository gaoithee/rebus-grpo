...
trainer = SFTTrainer(
    ...
    args = TrainingArguments(
        ...
        eval_steps = 500,
        push_to_hub = True,
        hub_model_id = "llama-3.1-8b-rebus-solver-coldstart-retrained",
        report_to="wandb",
        max_steps=500,
    ),
)
...
model.push_to_hub_merged("llama-3.1-8b-rebus-solver-coldstart-retrained", tokenizer, save_method = "merged_16bit")
