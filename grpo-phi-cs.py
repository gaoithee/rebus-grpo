...
model, tokenizer = FastLanguageModel.from_pretrained(
    model_name = "saracandu/phi3-mini-rebus-solver-coldstart-retrained", # MODEL OR ADAPTER FOLDER
...
wandb.init(project="phi-GRPO-coldstart")
