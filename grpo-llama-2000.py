...
model, tokenizer = FastLanguageModel.from_pretrained(
    ...
    max_seq_length = 1248,
    load_in_4bit = True,
    revision="960d6e6b1d3e59210082a41c5f20413d63ad9e96" # preso da https://huggingface.co/gsarti/phi3-mini-rebus-solver-adapters/commits/main
)
...
wandb.init(project="llama-GRPO-2000")
print("Training begins...")
trainer.train()
print("Training ends!")

merged_model = trainer.model.merge_and_unload()
merged_model.push_to_hub("llama-3.1-8b-rebus-solver-grpo-2000", private=False, tags=["GRPO", "llama"])
tokenizer.push_to_hub("llama-3.1-8b-rebus-solver-grpo-2000")
