...
model, tokenizer = FastLanguageModel.from_pretrained(
    ...
    max_seq_length = 1248,
    load_in_4bit = True,
    revision="20b31a0f3e3723ce8bc82a32b08c51648e9d701a" # preso da https://huggingface.co/gsarti/phi3-mini-rebus-solver-adapters/commits/main
)
...
wandb.init(project="llama-GRPO-1000")
print("Training begins...")
trainer.train()
print("Training ends!")

merged_model = trainer.model.merge_and_unload()
merged_model.push_to_hub("llama-3.1-8b-rebus-solver-grpo-1000", private=False, tags=["GRPO", "llama"])
tokenizer.push_to_hub("llama-3.1-8b-rebus-solver-grpo-1000")
