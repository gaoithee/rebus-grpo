...
model, tokenizer = FastLanguageModel.from_pretrained(
    ...
    max_seq_length = 1248,
    load_in_4bit = True,
    revision="3a811677bbd53387bb010cd852e64d3bae139ac8" # preso da https://huggingface.co/gsarti/phi3-mini-rebus-solver-adapters/commits/main
)
...
wandb.init(project="llama-GRPO-3000")
print("Training begins...")
trainer.train()
print("Training ends!")

merged_model = trainer.model.merge_and_unload()
merged_model.push_to_hub("llama-3.1-8b-rebus-solver-grpo-3000", private=False, tags=["GRPO", "llama"])
tokenizer.push_to_hub("llama-3.1-8b-rebus-solver-grpo-3000")
