...
from reward_funcs_coldstart import combined_rewards
...
model, tokenizer = FastLanguageModel.from_pretrained(
    model_name = "saracandu/llama-3.1-8b-rebus-solver-coldstart-retrained", # MODEL OR ADAPTER FOLDER
...
training_args = GRPOConfig(
    ...
    max_grad_norm=0.1,
    report_to = ["wandb"],
    output_dir="GRPO-llama-coldstart",
)
...
wandb.init(project="llama-GRPO-coldstart")
