...
wandb.init(project="cold-start-phi")
print("Training starts")
trainer_stats = trainer.train()
print("Training ends")


model.push_to_hub_merged("phi3-mini-rebus-solver-coldstart", tokenizer, save_method = "merged_16bit")
