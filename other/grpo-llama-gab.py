...
from reward_funcs import combined_rewards_gab
import wandb
...
trainer = GRPOTrainer(
    ...
    reward_funcs=[combined_rewards_gab],
    args=training_args,
    train_dataset=eval_dataset,
)

wandb.init(project="llama-GRPO-gab")
...
merged_model.push_to_hub(
    "llama-3.1-8b-rebus-solver-grpo-gab", private=False, tags=["GRPO", "llama"]
)
tokenizer.push_to_hub("llama-3.1-8b-rebus-solver-grpo-gab")
