...
wandb.init(project="phi-GRPO-gab")
...
merged_model.push_to_hub(
     "phi3-mini-rebus-solver-grpo-gab", private=False, tags=["GRPO", "phi3"]
)
tokenizer.push_to_hub("phi3-mini-rebus-solver-grpo-gab")
