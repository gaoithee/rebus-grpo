...
model, tokenizer = FastLanguageModel.from_pretrained(
    ...
    max_seq_length = 1248,
    load_in_4bit = True,
    revision="94df63013a339abc5938711202522ee398ba4c01" # preso da https://huggingface.co/gsarti/phi3-mini-rebus-solver-adapters/commits/main
)
...
wandb.init(project="llama-GRPO-4000")
print("Training begins...")
trainer.train()
print("Training ends!")

merged_model = trainer.model.merge_and_unload()
merged_model.push_to_hub("llama-3.1-8b-rebus-solver-grpo-4000", private=False, tags=["GRPO", "llama"])
tokenizer.push_to_hub("llama-3.1-8b-rebus-solver-grpo-4000")
