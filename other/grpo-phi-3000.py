...
model, tokenizer = FastLanguageModel.from_pretrained(
    ...
    max_seq_length = 1248,
    load_in_4bit = True,
    revision="58d2aa2753afb6f1092b61c7c4617a7c91f3f26c" # preso da https://huggingface.co/gsarti/phi3-mini-rebus-solver-adapters/commits/main
)
...
wandb.init(project="phi-GRPO-3000")
print("Training begins...")
trainer.train()
print("Training ends!")

merged_model = trainer.model.merge_and_unload()
merged_model.push_to_hub("phi3-mini-rebus-solver-grpo-3000", private=False, tags=["GRPO", "phi3"])
tokenizer.push_to_hub("phi3-mini-rebus-solver-grpo-3000")
